...
class ConfigTest extends TestCase
{
    ...
    public function testOldPasswordParam(): void
    {
        $configurationArray = [
            'parameters' => [
                'data_dir' => '/code/tests/Keboola/DbWriter/../../data',
        ...
        $config = new Config($configurationArray, new ActionConfigDefinition());
        $this->assertArrayHasKey('#password', $config->getParameters()['db']);
        $this->assertEquals('rootpassword', $config->getParameters()['db']['#password']);
    }
    ...
    public function testOldSshPrivateKey(): void
    {
        $configurationArray = [
            'parameters' => [
                'data_dir' => '/code/tests/Keboola/DbWriter/../../data',
                ...
                'db' => [
                    ...
                    'ssh' => [
                        ...
                        'sshPort' => '22',
                        'localPort' => '33306',
                        'keys' => ['public' => 'anyPublicKey', 'private' => 'anyPrivateKey'],
                        'maxRetries' => 10,
                    ],
                ],
            ],
        ...
        $config = new Config($configurationArray, new ActionConfigDefinition());
        $this->assertArrayHasKey('#private', $config->getParameters()['db']['ssh']['keys']);
        $this->assertEquals('anyPrivateKey', $config->getParameters()['db']['ssh']['keys']['#private']);
    }
